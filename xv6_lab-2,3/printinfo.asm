...
_printinfo:     file format elf32-i386
...
main(int argc, char *argv[])
{
   ...
   e:	83 ec 04             	sub    $0x4,%esp
    printinfo();
  11:	e8 34 03 00 00       	call   34a <printinfo>
    exit();
...
putc(int fd, char c)
{
 ...
 3d8:	e8 a5 fe ff ff       	call   282 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 448:	50                   	push   %eax
 449:	57                   	push   %edi
 44a:	e8 33 fe ff ff       	call   282 <write>
...
putc(int fd, char c)
{
 ...
 4aa:	50                   	push   %eax
 4ab:	57                   	push   %edi
 4ac:	e8 d1 fd ff ff       	call   282 <write>
 ...
 4c1:	e8 bc fd ff ff       	call   282 <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
 ...
 58f:	50                   	push   %eax
 590:	57                   	push   %edi
 591:	e8 ec fc ff ff       	call   282 <write>
