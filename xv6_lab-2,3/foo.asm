...
main(int argc, char *argv[])
{
   ...
   d:	53                   	push   %ebx
   e:	51                   	push   %ecx
   f:	bb 02 00 00 00       	mov    $0x2,%ebx
    int id;
    int n = 2;
    int k;
    for (k = 0; k < n; k++) {
        id = fork();
  14:	e8 71 02 00 00       	call   28a <fork>
        if (id < 0) {
  19:	85 c0                	test   %eax,%eax
  1b:	78 1b                	js     38 <main+0x38>
...
main(int argc, char *argv[])
{
  ...
  24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    while(wait()>0);
  28:	e8 6d 02 00 00       	call   29a <wait>
  2d:	85 c0                	test   %eax,%eax
  2f:	7f f7                	jg     28 <main+0x28>
    exit();
  31:	e8 5c 02 00 00       	call   292 <exit>
  36:	eb fe                	jmp    36 <main+0x36>
    int n = 2;
    int k;
    for (k = 0; k < n; k++) {
        id = fork();
        if (id < 0) {
            printf(1, "%d failed in fork!\n", getpid());
  38:	e8 d5 02 00 00       	call   312 <getpid>
  3d:	52                   	push   %edx
  3e:	50                   	push   %eax
