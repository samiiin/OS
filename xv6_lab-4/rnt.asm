...
init_reentrant_lock();
  11:	e8 1c 03 00 00       	call   332 <init_reentrant_lock>
reentrant();
  16:	e8 07 03 00 00       	call   322 <reentrant>
...
printf(int fd, const char *fmt, ...)
{
 ...
 5a4:	e9 8f fe ff ff       	jmp    438 <printf+0x48>
          s = "(null)";
 5a9:	bb 62 07 00 00       	mov    $0x762,%ebx
        while(*s != 0){
